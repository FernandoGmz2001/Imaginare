...
import nftContract from '../artifacts/contracts/NFT.sol/Pixel.json' with {type: "json"}
...
async function main() {
	...
	const factory = new ContractFactory(nftContract.abi, nftContract.bytecode, signer);
