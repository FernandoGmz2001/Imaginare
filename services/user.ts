...
const usersContract = new ethers.Contract(usersContractAddress, UsersAbi.abi, signer);


export const insertUser = async (firstName: string, lastName: string): Promise<number | undefined> => {
	try{
